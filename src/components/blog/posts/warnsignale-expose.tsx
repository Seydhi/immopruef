export default function WarnsignaleExpose() {
  return (
    <>
      <p>
      ...
      <h3>1. Preis deutlich unter Marktniveau</h3>
      <p>
      ...
      <h3>2. Keine Besichtigung möglich</h3>
      <p>
      ...
      <h3>3. Vorauszahlung vor dem Notartermin</h3>
      <p>
      ...
      <h3>4. Fehlender Energieausweis</h3>
      <p>
      ...
      <h3>5. Nur wenige oder keine Innenfotos</h3>
      <p>
      ...
      <h2>Subtile Warnsignale: Was zwischen den Zeilen steht</h2>
      <p>
      ...
      <h3>6. Maklersprache ohne konkrete Fakten</h3>
      <p>
      ...
      <table>
        <thead>
          <tr><th>Formulierung</th><th>Mögliche Realität</th></tr>
        </thead>
        <tbody>
          <tr><td>"Liebhaberobjekt"</td><td>Stark sanierungsbedürftig, unwirtschaftlich</td></tr>
          <tr><td>"Gut erhalten"</td><td>Nicht modernisiert, Originalzustand der 70er/80er</td></tr>
          <tr><td>"Ruhige Lage"</td><td>Abgelegen, schlechte ÖPNV-Anbindung</td></tr>
          <tr><td>"Verkehrsgünstig gelegen"</td><td>Straßenlärm, direkt an der Hauptstraße</td></tr>
          <tr><td>"In Kürze bezugsfertig"</td><td>Noch nicht bezugsfertig, Zeitrahmen unklar</td></tr>
          <tr><td>"Ideal für Handwerker"</td><td>Umfangreiche Eigenleistung nötig, kein Einzug möglich</td></tr>
          <tr><td>"Kompakt geschnitten"</td><td>Klein, möglicherweise ungünstige Raumaufteilung</td></tr>
        </tbody>
      </table>
      <p>
      ...
      <ul>
        <li>Balkone zu 100 % statt korrekt zu 25 % angerechnet</li>
        <li>Dachschrägen unter 2 m Höhe voll statt zu 50 % gezählt</li>
        <li>Keller oder Hobbyräume als Wohnfläche deklariert</li>
        <li>DIN 277 (Nutzfläche) statt WoFlV (Wohnfläche) verwendet — das kann 10–15 % Unterschied machen</li>
      </ul>
      <p>
        Fordern Sie immer die Wohnflächenberechnung an. Abweichungen über 10 % können ein Grund für Preisverhandlung sein.
      </p>

      <h3>8. Auffällig niedriges Hausgeld</h3>
      <p>
      ...
      <ul>
        <li>Die Instandhaltungsrücklage ist zu niedrig — Sonderumlagen drohen</li>
        <li>Notwendige Reparaturen werden aufgeschoben</li>
        <li>Kein Hausmeisterservice, keine professionelle Verwaltung</li>
      </ul>
      <p>
      ...
      <h3>9. Keine Angabe zum Baujahr der Heizung</h3>
      <p>
      ...
      <h3>10. Unklare Modernisierungshinweise</h3>
      <p>
      ...
      <ul>
        ...
        <li>Liegen Rechnungen und Handwerkerbelege vor?</li>
        <li>Wurden Arbeiten fachgerecht oder in Eigenleistung ausgeführt?</li>
      </ul>
      <p>
      ...
      <h2>Warnsignale im Zusammenspiel erkennen</h2>
      <p>
      ...
      <h3>Kombination 1: Preis + Energie + Baujahr</h3>
      <p>
      ...
      <h3>Kombination 2: Wenig Fotos + "Liebhaberobjekt" + kein Energieausweis</h3>
      <p>
      ...
      <h3>Kombination 3: Niedriges Hausgeld + alte Heizung + keine WEG-Protokolle</h3>
      <p>
      ...
      <h2>Checkliste: So prüfen Sie ein Exposé systematisch</h2>
      <ol>
        <li><strong>Preis prüfen:</strong> Quadratmeterpreis mit Bodenrichtwert und ähnlichen Angeboten vergleichen</li>
        <li><strong>Energieausweis:</strong> Klasse, Kennwert und Heizungstyp vorhanden?</li>
        <li><strong>Wohnfläche:</strong> Berechnungsgrundlage (WoFlV?) anfordern</li>
        <li><strong>Fotos:</strong> Alle Räume abgebildet? Aktuell oder offensichtlich älter?</li>
        <li><strong>Konkrete Daten:</strong> Baujahr, letzte Sanierung, Hausgeld mit Aufschlüsselung?</li>
        <li><strong>Fehlende Infos:</strong> Was wird nicht erwähnt? Provision, Grundriss, Keller, Stellplatz?</li>
        <li><strong>Formulierungen:</strong> Mehr Fakten oder mehr Adjektive?</li>
        <li><strong>Gesamtbild:</strong> Passen Preis, Zustand, Lage und Energie zusammen?</li>
      </ol>

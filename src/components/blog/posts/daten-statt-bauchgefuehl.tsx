export default function DatenStattBauchgefuehl() {
  return (
    <>
      <p>
      ...
      <h3>2. Kognitive Verzerrungen</h3>
      <p>
        Unser Gehirn spielt uns Streiche die wir nicht bemerken:
      </p>
      <ul>
        <li><strong>Ankereffekt:</strong> Der Angebotspreis wird zum Referenzpunkt. Alles darunter fühlt sich wie ein Schnäppchen an — auch wenn es keines ist.</li>
        <li><strong>Halo-Effekt:</strong> Die neue Küche überstrahlt die marode Elektrik. Ein positives Detail färbt auf die Gesamtbewertung ab.</li>
        <li><strong>Bestätigungsfehler:</strong> Wenn Sie ein Objekt mögen, suchen Sie unbewusst nach Bestätigung — und übersehen Gegenargumente.</li>
        <li><strong>Verfügbarkeitsheuristik:</strong> "In dieser Gegend gibt es kaum Angebote" — also greifen Sie zu, auch wenn der Preis nicht stimmt. Die Angst etwas zu verpassen überwiegt die Analyse.</li>
      </ul>

      <h3>3. Informationsasymmetrie</h3>
      <p>
      ...
      <h2>Die 10 Datenpunkte die jeder Käufer kennen sollte</h2>
      <p>
      ...
      <h3>1. Quadratmeterpreis (bereinigt)</h3>
      <p>
      ...
      <h3>4. Energiekennwert und Heizkosten</h3>
      <p>
      ...
      <h3>9. Hausgeld-Zusammensetzung (bei ETW)</h3>
      <p>
      ...
      <h2>So funktioniert datenbasierte Bewertung in der Praxis</h2>

      <h3>Schritt 1: Daten sammeln (15 Minuten)</h3>
      <table>
        <thead>
          <tr><th>Datenquelle</th><th>Was Sie erhalten</th><th>Zeitaufwand</th></tr>
        </thead>
        <tbody>
          <tr><td>Exposé</td><td>Preis, Fläche, Baujahr, Energie, Hausgeld</td><td>3 Min.</td></tr>
          <tr><td>Eigene Berechnung</td><td>€/m², Gesamtinvestition, Heizkosten</td><td>3 Min.</td></tr>
          <tr><td>Google Maps</td><td>ÖPNV, Supermarkt, Schule, Arbeitsweg</td><td>3 Min.</td></tr>
          <tr><td>Lärmkarte</td><td>dB(A) für die Adresse</td><td>2 Min.</td></tr>
          <tr><td>BORIS-Portal</td><td>Bodenrichtwert</td><td>2 Min.</td></tr>
          <tr><td>Immobilienportal</td><td>2–3 Vergleichsobjekte</td><td>2 Min.</td></tr>
        </tbody>
      </table>

      <h3>Schritt 2: Daten bewerten (10 Minuten)</h3>
      <p>
        Erstellen Sie eine Bewertungskarte mit 5 Kategorien, jeweils 1–10 Punkte:
      </p>
      <table>
        <thead>
          <tr><th>Kategorie</th><th>Gewicht</th><th>Was fließt ein</th></tr>
        </thead>
        <tbody>
          <tr><td>Lage</td><td>25 %</td><td>ÖPNV, Lärm, Infrastruktur, Bodenrichtwert, Trend</td></tr>
          <tr><td>Preis-Leistung</td><td>25 %</td><td>Bereinigter €/m² vs. Vergleichsobjekte</td></tr>
          <tr><td>Zustand</td><td>20 %</td><td>Baujahr, Sanierung, Bauteil-Restlebensdauer</td></tr>
          <tr><td>Energie</td><td>15 %</td><td>Klasse, Heizkosten, GEG-Pflichten</td></tr>
          <tr><td>Finanzierung</td><td>15 %</td><td>Monatliche Belastung, Eigenkapital, Stresstest</td></tr>
        </tbody>
      </table>

      <h3>Schritt 3: Bauchgefühl hinzufügen (5 Minuten)</h3>
      <p>
        Jetzt — nach der Datenanalyse — hat das Bauchgefühl seinen Platz. Fragen Sie sich:
      </p>
      <ul>
        <li>Kann ich mir vorstellen, hier 10+ Jahre zu leben?</li>
        <li>Passt der Grundriss zu meinem Alltag?</li>
        <li>Fühle ich mich in der Nachbarschaft wohl?</li>
        <li>Gibt es etwas das mich stört und das ich nicht ändern kann?</li>
      </ul>
      <p>
      ...
      <h2>Bauchgefühl vs. Daten: Wann was zählt</h2>
      <table>
        <thead>
          <tr><th>Entscheidung</th><th>Daten</th><th>Bauchgefühl</th></tr>
        </thead>
        <tbody>
          <tr><td>Ist der Preis fair?</td><td>✅ Entscheidend</td><td>❌ Irreführend</td></tr>
          <tr><td>Wie hoch sind die Folgekosten?</td><td>✅ Entscheidend</td><td>❌ Nicht einschätzbar</td></tr>
          <tr><td>Stimmt die Lage?</td><td>✅ Für Infrastruktur</td><td>✅ Für Atmosphäre</td></tr>
      ...
      <h2>Praxisbeispiel: Zwei Käufer, dasselbe Objekt</h2>

      <h3>Käufer A: Bauchgefühl-Entscheider</h3>
      <p>
      ...
      <h3>Käufer B: Datenbasierter Entscheider</h3>
      <p>
      ...
      <h2>Häufiger Einwand: "Ich habe keine Zeit für so viel Recherche"</h2>
      <p>
        Die Datenerhebung für eine fundierte Bewertung dauert 15–20 Minuten pro Objekt. Verglichen mit:
      </p>
      <ul>
        <li>Anfahrt + Besichtigung + Nachbereitung: 2–3 Stunden</li>
        <li>Eine unnötige Besichtigung vermieden: 2–3 Stunden gespart</li>
        <li>Ein Fehler der 30.000 € kostet: unbezahlbar</li>
      </ul>
      <p>

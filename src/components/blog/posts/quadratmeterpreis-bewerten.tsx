export default function QuadratmeterpreisBewerten() {
  return (
    <>
      <p>
      ...
      <h3>1. Lage — der wichtigste Preistreiber</h3>
      <p>
      ...
      <ul>
        ...
        <li>Dachsanierung: 15.000–30.000 €</li>
        <li>Fensteraustausch: 10.000–25.000 €</li>
        <li>Elektrik erneuern: 8.000–15.000 €</li>
      </ul>
      <p>
      ...
      <h3>4. Wohnfläche und Raumaufteilung</h3>
      <p>
      ...
      <h3>5. Ausstattung und Zustand</h3>
      <p>
      ...
      <ul>
        <li>Sind Bäder und Küche modernisiert?</li>
        <li>Welche Bodenbeläge sind verlegt?</li>
        <li>Gibt es einen Aufzug? (besonders relevant ab 3. OG)</li>
        <li>Stellplatz oder Garage vorhanden?</li>
        <li>Balkon, Terrasse oder Garten?</li>
      </ul>

      <h3>6. Hausgeld und laufende Kosten (bei ETW)</h3>
      <p>
      ...
      <h3>7. Kaufnebenkosten und Gesamtinvestition</h3>
      <p>
      ...
      <h2>Praxisbeispiel: Zwei Wohnungen im Vergleich</h2>
      <p>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Wohnfläche</td><td>75 m²</td><td>78 m²</td></tr>
          <tr><td>Preis/m²</td><td>3.733 €</td><td>4.359 €</td></tr>
          <tr><td>Baujahr</td><td>1968</td><td>2019</td></tr>
          <tr><td>Energieklasse</td><td>F</td><td>A</td></tr>
          <tr><td>Heizkosten/Jahr</td><td>ca. 1.350 €</td><td>ca. 310 €</td></tr>
          <tr><td>Sanierungsbedarf</td><td>ca. 45.000 €</td><td>0 €</td></tr>
          <tr><td>Hausgeld/Monat</td><td>320 €</td><td>280 €</td></tr>
        </tbody>
      </table>
      <p>
      ...
      <h2>Wann ein hoher Quadratmeterpreis gerechtfertigt ist</h2>
      <ul>
        <li>Neuwertige oder kernsanierte Immobilie ohne Investitionsstau</li>
        <li>Energieeffizienzklasse A oder B</li>
        <li>Gefragte Lage mit stabiler oder steigender Bevölkerung</li>
        <li>Gute Infrastruktur (ÖPNV, Schulen, Einkauf unter 500 m)</li>
        <li>Niedrige laufende Kosten (Hausgeld, Heizung)</li>
        <li>Aufwertungspotenzial im Stadtteil</li>
      </ul>

      <h2>Wann Sie genauer hinschauen sollten</h2>
      <ul>
        <li>Preis liegt deutlich über dem regionalen Bodenrichtwert</li>
        <li>Hoher Preis bei schlechter Energieeffizienz (Klasse E oder schlechter)</li>
        <li>Unsanierter Altbau zum Neubaupreis</li>
        <li>Geringe Instandhaltungsrücklage bei der WEG</li>
        <li>Schrumpfende Region mit sinkender Kaufkraft</li>
        <li>Keine nachvollziehbare Wohnflächenberechnung</li>
      </ul>

      <h2>Fazit: Den Quadratmeterpreis im Kontext bewerten</h2>
      <p>

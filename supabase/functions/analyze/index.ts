...
- Maklergebühr: Wenn im Exposé NICHT explizit "provisionsfrei" steht, IMMER 3,57% (inkl. MwSt.) je Partei ansetzen — das ist der übliche Satz in Deutschland seit 2020. Nur bei explizitem "provisionsfrei" oder "käuferprovisionsfrei" auf 0% setzen.
